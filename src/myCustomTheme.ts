...
export const myCustomTheme: CustomThemeConfig = {
	...
	properties: {
		...
		// =~= Theme Colors  =~=
		// primary | #0568056
		'--color-primary-50': '230 236 230', // #e6ece6
		'--color-primary-100': '221 230 221', // #dde6dd
		'--color-primary-200': '213 223 213', // #d5dfd5
		'--color-primary-300': '187 204 187', // #bbccbb
		'--color-primary-400': '137 166 137', // #89a689
		'--color-primary-500': '86 128 86', // #568056
		'--color-primary-600': '77 115 77', // #4d734d
		'--color-primary-700': '65 96 65', // #416041
		'--color-primary-800': '52 77 52', // #344d34
		'--color-primary-900': '42 63 42', // #2a3f2a
		// secondary | #4F46E5
